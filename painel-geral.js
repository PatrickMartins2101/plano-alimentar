...
function carregar(src){const s=document.createElement('script');s.src=src+'?v=20260920-v2-editor';s.defer=false;document.head.appendChild(s)}
...
function init(){render();['perfil-metas.js','peso-evolucao.js','ajuste-meta-agua.js','plano-prescrito.js','editor-plano.js','calendario.js','fotos-evolucao.js','backup-restauracao.js','notificacoes.js','meta-atividade.js','dashboard-progresso.js'].forEach(carregar);const o=document.createElement('script');o.src='receita-foto-ocr.js?v=20260920-ocr4';o.defer=false;document.head.appendChild(o)}
